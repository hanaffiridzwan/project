                    ...
                    <form class="form-horizontal" role="form" method="POST" action="{{ route('register') }}">
                        {{ csrf_field() }}
                         <div class="form-group{{ $errors->has('category') ? ' has-error' : '' }}">
                            <!-- <label for="category" class="col-md-4 control-label">Kategori Pengguna</label>
                             <div class="col-md-6">
                        ...
                        <div class="form-group">
                            <label for="password-confirm" class="col-md-4 control-label">konfirm Katalaluan</label>
